...
const video2 = {
  ...
  snippet: {
    ...
    channelId: 'UCPGzT4wecuWM0BH9mPiulXg',
    title:
      'San Francisco to Guadalajara: Why I Moved From the Bay Area to Mexico for My Career',
    description:
      'Claire Wright is a Project Manager at Wizeline, and made the move from Silicon Valley to Guadalajara last year. Watch Claire’s Collaboration Without Borders story to learn about her time abroad, and why she’s having the most valuable experiences of her career!\n\nUp for a challenge? Apply today: www.wizeline.com/careers',
    thumbnails: {
      default: {
